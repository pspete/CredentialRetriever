...
# Run Pester Tests                #
#---------------------------------#
$files = Get-ChildItem ".\CredentialRetriever" -Include *.ps1 -Recurse

$res = Invoke-Pester -Path ".\tests" -OutputFormat NUnitXml -OutputFile TestsResults.xml -CodeCoverage $files -PassThru
